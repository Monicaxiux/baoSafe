        ...
        <div class="container">
            <div class="row">
                        ...
                        <g>
                            ...
                            <g id="planet" transform="matrix(0.9994,-0.0336,0.0336,0.9994,-3.315,19.1486)"
                                ...
                                <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3"
                                    ...
                                    transform="matrix(1,0,0,1,-2.892,0)" style="transform-origin: 0px 0px;">
                                </circle>
                            ...
                            <g id="stars">
                                ...
                                <g id="circlesBig">
                                    <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                        ...
                                        transform="matrix(1,0,0,1,0,-1.928)" style="transform-origin: 0px 0px;">
                                    </circle>
                                    <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                ...
                                <g id="circlesSmall">
                                    <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651"
                                        transform="matrix(1,0,0,1,0,-3.857)" style="transform-origin: 0px 0px;">
                                    </circle>
                ...
                <div class="col-md-6 align-self-center">
                    ...
                    <router-link to="/externalPartners">
