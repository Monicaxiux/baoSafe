<template>
    <el-table :data="tableData" class="tablex">
        <template v-if="tableType">
            <el-table-column prop="username" label="员工姓名" width="200" />
            ...
            <el-table-column prop="receiveDate" label="取证日期" />
            <el-table-column prop="expiryTime" label="复证日期" />
            <el-table-column prop="restoreDate" label="到期日期" />
